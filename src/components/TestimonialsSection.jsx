    ...
    return (
        <section id='testimonials'
            ...
            <div className='text-center mb-12'>
                ...
                <p className='text-gray-600 text-lg mb-12'>Things that make it the best  to start trading with us</p>
            </div>
            {/* testimonials card */}
            <div >
                {/* swiper card */}
                ...
                <div className='flex justify-center -ml-4 gap-4 md:mt-8 mt-4'>
                    <button className='swiper-button-prev-custom
                        w-12 h-12 rounded-full text-gray-600 border border-gray-200 cursor-pointer
                        flex items-center justify-center hover:bg-blue-500 hover:text-white transition-all duration-200'>
